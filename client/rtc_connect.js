...
function init(SIGNALING_SERVER) {
	console.log("Connecting to signaling server", SIGNALING_SERVER);
	signaling_socket = io(SIGNALING_SERVER);
	signaling_socket = io();

	signaling_socket.on('connect', async function() {
	...
	*/
	signaling_socket.on('addPeer', function(config) {
		...
		peer_connection.onaddstream = function(event) {
			...
			peer_media_elements[peer_id]  = createAudioElement(event.stream, false)
...
const createAudioElement = (stream, isMuted=false)=>{
